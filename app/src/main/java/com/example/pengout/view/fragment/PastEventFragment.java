...
public class PastEventFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        eventsView =  inflater.inflate(R.layout.fragment_past_event, container, false);

        eventsList = eventsView.findViewById(R.id.past_events_list);
        eventsList.setLayoutManager(new LinearLayoutManager(getContext()));

        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();

        eventsRef = FirebaseDatabase.getInstance().getReference().child("contacts").child(currentUserID);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions options =
                new FirebaseRecyclerOptions.Builder<Contacts>()
                        .setQuery(eventsRef, Contacts.class)
                        .build();
